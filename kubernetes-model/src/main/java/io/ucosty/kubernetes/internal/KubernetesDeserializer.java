 ...
 */
package io.ucosty.kubernetes.internal;
...
import io.ucosty.kubernetes.api.model.KubernetesResource;
...
public class KubernetesDeserializer extends JsonDeserializer<KubernetesResource> {
    ...
    private static final String KUBERNETES_PACKAGE_PREFIX = "io.ucosty.kubernetes.api.model.";
    private static final String KUBERNETES_EXTENSIONS_PACKAGE_PREFIX = "io.ucosty.kubernetes.api.model.extensions.";
    private static final String KUBERNETES_APIEXTENSIONS_PACKAGE_PREFIX = "io.ucosty.kubernetes.api.model.apiextensions.";
    private static final String OPENSHIFT_PACKAGE_PREFIX = "io.ucosty.openshift.api.model.";
