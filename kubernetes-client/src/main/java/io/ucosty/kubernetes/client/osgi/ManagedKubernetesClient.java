...
package io.ucosty.kubernetes.client.osgi;

import io.ucosty.kubernetes.api.model.*;
...
import io.ucosty.kubernetes.client.Adapters;
import io.ucosty.kubernetes.client.BaseClient;
import io.ucosty.kubernetes.client.Config;
import io.ucosty.kubernetes.client.ConfigBuilder;
import io.ucosty.kubernetes.client.CustomResourceList;
import io.ucosty.kubernetes.client.DefaultKubernetesClient;
import io.ucosty.kubernetes.client.ExtensionAdapter;
import io.ucosty.kubernetes.client.Handlers;
import io.ucosty.kubernetes.client.KubernetesClient;
import io.ucosty.kubernetes.client.NamespacedKubernetesClient;
import io.ucosty.kubernetes.client.RequestConfig;
...
import static io.ucosty.kubernetes.client.Config.*;

@Component(immediate = true, configurationPid = "io.ucosty.kubernetes.client", policy = ConfigurationPolicy.OPTIONAL)
@Service({KubernetesClient.class,NamespacedKubernetesClient.class})
@References({
  @Reference(referenceInterface = io.ucosty.kubernetes.client.ResourceHandler.class, cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, policy = ReferencePolicy.DYNAMIC, bind = "bindResourceHandler", unbind = "unbindResourceHandler"),
...
public class ManagedKubernetesClient extends BaseClient implements NamespacedKubernetesClient {
  ...
  public MixedOperation<io.ucosty.kubernetes.api.model.Service, ServiceList, DoneableService, Resource<io.ucosty.kubernetes.api.model.Service, DoneableService>> services() {
