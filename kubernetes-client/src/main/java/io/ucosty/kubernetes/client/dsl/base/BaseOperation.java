 ...
 */
package io.ucosty.kubernetes.client.dsl.base;

import io.ucosty.kubernetes.api.model.HasMetadata;
import io.ucosty.kubernetes.api.model.LabelSelector;
import io.ucosty.kubernetes.api.model.LabelSelectorRequirement;
import io.ucosty.kubernetes.api.model.ObjectMeta;
import io.ucosty.kubernetes.client.OperationInfo;
import io.ucosty.kubernetes.client.dsl.Replaceable;
import io.ucosty.kubernetes.client.dsl.Resource;
import io.ucosty.kubernetes.client.dsl.internal.DefaultOperationInfo;
import io.ucosty.kubernetes.client.internal.readiness.Readiness;
import io.ucosty.kubernetes.client.utils.Utils;
import okhttp3.HttpUrl;
import okhttp3.OkHttpClient;
import okhttp3.Request;
import io.ucosty.kubernetes.api.builder.Function;
...
import io.ucosty.kubernetes.client.KubernetesClientException;
...
import io.ucosty.kubernetes.client.dsl.Deletable;
import io.ucosty.kubernetes.client.dsl.EditReplacePatchDeletable;
import io.ucosty.kubernetes.client.dsl.FilterWatchListDeletable;
import io.ucosty.kubernetes.client.dsl.Gettable;
import io.ucosty.kubernetes.client.dsl.Reaper;
import io.ucosty.kubernetes.client.dsl.Watchable;
import io.ucosty.kubernetes.client.dsl.internal.WatchConnectionManager;
import io.ucosty.kubernetes.client.dsl.internal.WatchHTTPManager;
import io.ucosty.kubernetes.client.utils.URLUtils;
...
import static io.ucosty.kubernetes.client.utils.Utils.isNotNullOrEmpty;
import static io.ucosty.kubernetes.client.utils.Utils.join;
