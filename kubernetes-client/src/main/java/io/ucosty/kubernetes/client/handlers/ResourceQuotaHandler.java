...
import io.ucosty.kubernetes.api.model.ResourceQuotaBuilder;
...
public class ResourceQuotaHandler implements ResourceHandler<ResourceQuota, ResourceQuotaBuilder> {
  ...
  public ResourceQuota replace(OkHttpClient client, Config config, String namespace, ResourceQuota item) {
    return new ResourceQuotaOperationsImpl(client, config, null, namespace, null, true, item, null, true, -1, new TreeMap<String, String>(), new TreeMap<String, String>(), new TreeMap<String, String[]>(), new TreeMap<String, String[]>(), new TreeMap<String, String>()).replace(item);
  }
  ...
  public Watch watch(OkHttpClient client, Config config, String namespace, ResourceQuota item, Watcher<ResourceQuota> watcher) {
    return new ResourceQuotaOperationsImpl(client, config, null, namespace, null, true, item, null, false, -1, new TreeMap<String, String>(), new TreeMap<String, String>(), new TreeMap<String, String[]>(), new TreeMap<String, String[]>(), new TreeMap<String, String>()).watch(watcher);
  }
