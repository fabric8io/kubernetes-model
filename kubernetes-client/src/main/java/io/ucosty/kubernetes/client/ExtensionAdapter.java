...
/**
 * An Adapter that can be used to adapt an instance of the {@link NamespacedKubernetesClient} to an {@link io.ucosty.kubernetes.client.Extension}.
 *
 * @param <C> The Client.
 */
public interface ExtensionAdapter<C> {
  ...
  /**
   * @return The concrete class of the {@link io.ucosty.kubernetes.client.Client}.
   */
   ...
   *
   * @param client The instance of {@link NamespacedKubernetesClient} to adapt.
   * @return The instance of the {@link io.ucosty.kubernetes.client.Client}.
   */
