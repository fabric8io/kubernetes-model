...
import static io.ucosty.kubernetes.client.Config.DEFAULT_LOGGING_INTERVAL;
import static io.ucosty.kubernetes.client.Config.DEFAULT_MAX_CONCURRENT_REQUESTS_PER_HOST;
import static io.ucosty.kubernetes.client.Config.DEFAULT_ROLLING_TIMEOUT;
import static io.ucosty.kubernetes.client.Config.DEFAULT_SCALE_TIMEOUT;
import static io.ucosty.kubernetes.client.Config.DEFAULT_WEBSOCKET_PING_INTERVAL;
import static io.ucosty.kubernetes.client.Config.DEFAULT_WEBSOCKET_TIMEOUT;
...
public class RequestConfig {
  ...
  @Buildable(builderPackage = "io.ucosty.kubernetes.api.builder", editableEnabled = false)
