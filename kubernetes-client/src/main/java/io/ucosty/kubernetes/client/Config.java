...
import io.ucosty.kubernetes.api.model.ConfigBuilder;
import okhttp3.TlsVersion;
import io.ucosty.kubernetes.api.model.AuthInfo;
import io.ucosty.kubernetes.api.model.Cluster;
import io.ucosty.kubernetes.api.model.Context;
import io.ucosty.kubernetes.client.internal.KubeConfigUtils;
import io.ucosty.kubernetes.client.internal.SSLUtils;
  ...
  private static boolean tryKubeConfig(Config config, String context) {
    ...
    if (Utils.getSystemPropertyOrEnvVar(KUBERNETES_AUTH_TRYKUBECONFIG_SYSTEM_PROPERTY, true)) {
      ...
      if (kubeConfigFileExists) {
        ...
        try {
          io.ucosty.kubernetes.api.model.Config kubeConfig = KubeConfigUtils.parseConfig(kubeConfigFile);
          if (context != null) {
