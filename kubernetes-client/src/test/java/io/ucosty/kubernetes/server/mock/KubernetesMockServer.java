 ...
 */
package io.ucosty.kubernetes.server.mock;

import io.ucosty.kubernetes.api.model.RootPathsBuilder;
...
@Deprecated
// The class has moved under mvn:io.ucosty:kubernetes-server-mock in package: io.ucosty.client.server.mock
